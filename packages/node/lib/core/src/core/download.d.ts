import { StatefulPromise } from '../common';
 ...
 */
export declare function getRealDownloadUrl(pageDownloadUrl: string): Promise<any>;
 ...
 * @param option
 */
export declare function download(option: DownloadOption): StatefulPromise<void>;
